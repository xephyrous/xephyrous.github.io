import{l as i}from"./firebase-DkWAoNHg.js";document.querySelector("#app").innerHTML=`
...
`;document.getElementById("login-button").addEventListener("click",()=>{i(document.getElementById("username_field").value,document.getElementById("password_field").value).then(t=>{t&&setTimeout(()=>{window.location="index.html"},100)})});
