import{a as m}from"./firebase-C6diCsfn.js";import{g as y}from"./youtube-Bniyde3c.js";document.addEventListener("DOMContentLoaded",()=>{let e=document.querySelector("elevenlabs-convai").shadowRoot,a={attributes:!0,childList:!0,subtree:!0};new MutationObserver(u).observe(e,a)});function u(){const a=document.querySelector("elevenlabs-convai").shadowRoot;let s=null,t=null;try{s=a.querySelector("div"),s.querySelector("._poweredBy_me40k_322").remove()}catch{}try{s=a.querySelector("div"),s.querySelector("._feedback_me40k_425").remove()}catch{}try{s=a.querySelector("._customContent_me40k_66"),t=s.querySelector("._box_me40k_37"),t.style.margin="10px";try{const n=t.querySelector("._terms_me40k_351"),o=n.querySelector("form"),i=o.querySelector("h4"),r=o.querySelector("p");i.style.fontFamily="Pixelated MS Sans Serif",r.style.fontFamily="Pixelated MS Sans Serif",n.querySelector("._termsFooter_me40k_414").querySelectorAll("button").forEach(d=>{d.style.fontFamily="Pixelated MS Sans Serif",d.style.fontWeight="bold",d.style.border="2px outset",d.style.backgroundColor="#c0c0c0"})}catch{}}catch{}try{s=a.querySelector("div"),t=s.querySelector("._box_me40k_37"),t.style.margin="10px";let n=!1;try{const o=t.querySelector("._inlineFeedback_me40k_455"),i=o.querySelector("span");i.style.fontFamily="Pixelated MS Sans Serif",o.querySelectorAll("button").forEach(c=>{c.style.border="2px outset",c.style.backgroundColor="#c0c0c0"})}catch{}t.style.backgroundColor="#c0c0c0",t.style.border="2px outset",t.style.position="absolute",t.style.bottom="-15px",t.style.right="-15px";try{const o=t.querySelector("._actions_me40k_119"),i=o.querySelector("p");i.style.color="black",i.style.fontFamily="Pixelated MS Sans Serif";const r=o.querySelector("button");r.style.fontFamily="Pixelated MS Sans Serif",r.style.border="2px outset"}catch{}try{const i=t.querySelector("._actionButtons_me40k_137").querySelector("button");i.style.fontFamily="Pixelated MS Sans Serif",i.style.backgroundColor="#c0c0c0",i.style.border="2px outset"}catch{}return}catch{}}let l=0;document.addEventListener("DOMContentLoaded",()=>{const e=document.getElementById("ask-jake-button");e.addEventListener("mouseover",()=>{l===0&&(e.src="button_hover.png",l=1)}),e.addEventListener("mousedown",()=>{l===1&&(e.src="button_press.png",l=2,b(),setTimeout(()=>{l===2&&(e.src="button_hover.png",l=1)},500))}),e.addEventListener("mouseout",()=>{l===2?setTimeout(()=>{e.src="button_n.png",l=0},500):l===1&&(e.src="button_n.png",l=0)})});function b(){const e=document.getElementById("jake-text").value;document.getElementById("jake-text").innerText="",e!==""&&m(e)}document.querySelector("#app").innerHTML=`
